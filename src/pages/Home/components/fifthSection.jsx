    ...
    return (
        <>
            <div className='py-16 flex flex-col gap-8'>
                ...
                <div className='w-[100%] flex gap-5 justify-center overflow-hidden'>
                    <div className='w-[25%] flex flex-col gap-2 hover:scale-105'>
                ...
                <div className='flex gap-11 justify-center py-10'>
                    <div className='border-r-2 w-[23%] text-center'>
                        <h3 className='text-xl'>Free Delivery Worldwide</h3>
                        <p className='text-slate-500'>Mirum est notare quam littera gothica</p>
                    </div>
                    <div className='border-r-2 w-[25%] text-center'>
